(function (window, u) {
	...
	endHandler = function (e, obj) {
		...
		if(!global.isMove && obj.index !== undefined && typeof obj.index === 'number'){
			// 
			angle = angle || 0;
			if(obj.index >= blockNumber / 2) {
				clickAngle = -(blockNumber - obj.index) * eachRotateAngle;
			}else{
				clickAngle = obj.index * eachRotateAngle;
			}
			angle = clickAngle;
