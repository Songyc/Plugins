(function (window, u) {
	...
	fn.extend(Guadrant, {
		...
		trigger: function (startAngle, endAngle) {
			...
			filterGuadrantListString = Guadrant.makerGuadrantList.call(this, startAngle);
			...
			originalFilterGuadrantListString1 = Guadrant.makerGuadrantList.call(this, startAngle, true, true);
			originalFilterGuadrantListString2 = Guadrant.makerGuadrantList.call(this, endAngle, true, true);
		...
		debugAngle: function (startAngle, endAngle, trigger) { 							// 解决鼠标从第二象限滑动到第三象限或者从第三象限滑动到第二象限的角度问题
			...
			if(!trigger) {
				originalFilterGuadrantListString = Guadrant.makerGuadrantList.call(this, endAngle, true); 				// 获取原始路径
				isReverse = Guadrant.isReverse.call(this, originalFilterGuadrantListString, startAngle, endAngle); 	// 获取旋转方向
				
			}else {
				reverseInfo = Guadrant.trigger.call(this, startAngle, endAngle);
	...
	fn.extend(Handler, {
		...
		moveHandler: function (e) {
			...
			slideAngle = Handler.countSlideAngle.call(this, startAngle, moveAngle, false, 'move');
			Handler.rotato.call(this, slideAngle + data.angle, data.transition, null, false);						// 动画
			...
			Event.on(doc, touchEnd, function (e) {
		...
		endHandler: function (e) {
			...
			isClick = Handler.isClick.call(this, e);
	...
	Dial.prototype = {
		...
		slide: function (slideAngle) {
			Handler.slide.call(this.dial, null, null, slideAngle, false);
		},
		unLock: function () {
			var data = Cache.data(this.dial, 'dataObj');
			if(!data.destroy) {
