...
(function () {
    ...
    function readyDom(iObj) {
        ...
        for (var i = 0, ln = matrix[0] * matrix[1]; i < ln; i++) {
            html.push('<li class="patt-circ" data-number = ' + i + ' style="margin:' + margin + 'px; width : ' + (radius * 2) + 'px; height : ' + (radius * 2) + 'px; -webkit-border-radius: ' + radius + 'px; -moz-border-radius: ' + radius + 'px; border-radius: ' + radius + 'px; "><div class="patt-dots"></div></li>');
        }
        html.push('</ul>');
    ...
    var startHandler = function (e, obj) {
        ...
        //assign events
        $(this).on(touchMove /*+ '.patternMove'*/, function (e) {
            moveHandler.call(this, e, obj);
        });
        // $(this).bind("patternMove", function (e){
        //        moveHandler.call(this, e, obj);
        // });
        ...
        endHandler = function (e, obj) {
            ...
            iObj.holder.off(touchMove).removeClass('patt-hidden');
